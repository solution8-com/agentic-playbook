...
When the document you're writing is a skill, read [`SKILL-MECHANICS.md`](SKILL-MECHANICS.md) for frontmatter, invocation choice, and router skills. When the skill belongs to this catalog, also read [`S8-RULES.md`](S8-RULES.md) for the house rules, the testing discipline, and the review checklist.
